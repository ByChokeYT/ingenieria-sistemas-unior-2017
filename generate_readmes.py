...
SYLLABUS_MAPPING = {
    ...
    "INF-100": {
        ...
        "title": "Informática I",
        "prereq": "Ninguno",
        "description": "Fundamentos de la computación, algoritmos, lógica de programación e introducción práctica al desarrollo de software, base para todas las materias de programación posteriores de la carrera (Estructura de Datos, Lenguajes de Programación, Bases de Datos, Ingeniería de Software).",
...
* Reingeniería de procesos organizacionales mediante la informática."""
    ...
    "ALF-100": {
        ...
        "prereq": "Ninguno",
        "description": "Introducción a las matemáticas discretas, lógica proposicional, teoría de conjuntos y estructuras algebraicas, base fundamental para el razonamiento computacional, el diseño de algoritmos, las bases de datos (álgebra relacional) y la arquitectura digital (circuitos lógicos).",
